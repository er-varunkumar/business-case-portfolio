...
```mermaid
graph LR
    A[Strong Brand] --> E[Premium Pricing]
    B[Superior Technology] --> E
    C[Exceptional Service] --> E
    D[Innovative Design] --> E
```
...
```mermaid
graph TD
    A[Flexible Manufacturing] --> C[Strong Competitive<br>Position]
    B[Total Quality Management] --> C
    D[Advanced IT Systems] --> C
    C --> E[Low Cost]
    C --> F[Differentiation]
```
